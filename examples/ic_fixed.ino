...
const int seven_segment_display19_d_bottom = 2;
const int seven_segment_display19_a_top = 3;
const int seven_segment_display19_b_upper_right = 4;
const int seven_segment_display19_dp_dot = 5;
const int seven_segment_display19_c_lower_right = 6;
const int seven_segment_display20_g_middle = 7;
const int seven_segment_display20_f_upper_left = 8;
const int seven_segment_display20_e_lower_left = 9;
const int seven_segment_display20_d_bottom = 10;
const int seven_segment_display20_a_top = 11;
const int seven_segment_display20_b_upper_right = 12;
const int seven_segment_display20_dp_dot = 13;
/* ====== Aux. Variables ====== */
...
boolean aux_jk_flip_flop_6_0_q = LOW;
boolean aux_jk_flip_flop_6_0_q_inclk = LOW;
boolean aux_jk_flip_flop_6_1_q = HIGH;
boolean aux_jk_flip_flop_6_1_q_inclk = LOW;
boolean aux_clock_7 = LOW;
unsigned long aux_clock_7_lastTime = 0;
const unsigned long aux_clock_7_interval = 1000;
// IC: INPUT
boolean aux_ic_8_not_x0_0 = LOW;
boolean aux_ic_8_and_0_1 = LOW;
boolean aux_ic_8_or_0_2 = LOW;
boolean aux_ic_8_xor_0_3 = LOW;
boolean aux_ic_8_not_0 = LOW;
boolean aux_ic_8_xor_1 = LOW;
boolean aux_ic_8_or_2 = LOW;
boolean aux_ic_8_and_3 = LOW;
boolean aux_ic_8_node_4 = LOW;
boolean aux_ic_8_node_5 = LOW;
boolean aux_ic_8_node_6 = LOW;
boolean aux_ic_8_node_7 = LOW;
boolean aux_ic_8_node_8 = LOW;
boolean aux_ic_8_node_9 = LOW;
// End IC: INPUT
boolean aux_clock_9 = LOW;
unsigned long aux_clock_9_lastTime = 0;
const unsigned long aux_clock_9_interval = 500;
boolean aux_clock_10 = LOW;
unsigned long aux_clock_10_lastTime = 0;
const unsigned long aux_clock_10_interval = 250;
// IC: DISPLAY-4BITS
boolean aux_ic_11_display7_g_middle = LOW;
boolean aux_ic_11_display7_f_upper_left_1 = LOW;
boolean aux_ic_11_display7_e_lower_left_2 = LOW;
boolean aux_ic_11_display7_d_bottom_3 = LOW;
boolean aux_ic_11_display7_a_top_4 = LOW;
boolean aux_ic_11_display7_b_upper_right_5 = LOW;
boolean aux_ic_11_display7_dp_dot_6 = LOW;
boolean aux_ic_11_display7_c_lower_right_7 = LOW;
boolean aux_ic_11_node_0 = LOW;
boolean aux_ic_11_node_1 = LOW;
boolean aux_ic_11_node_2 = LOW;
boolean aux_ic_11_node_3 = LOW;
boolean aux_ic_11_and_4 = LOW;
boolean aux_ic_11_node_5 = LOW;
boolean aux_ic_11_node_6 = LOW;
boolean aux_ic_11_node_7 = LOW;
boolean aux_ic_11_node_8 = LOW;
boolean aux_ic_11_node_9 = LOW;
boolean aux_ic_11_node_10 = LOW;
boolean aux_ic_11_node_11 = LOW;
boolean aux_ic_11_node_12 = LOW;
boolean aux_ic_11_node_13 = LOW;
boolean aux_ic_11_node_14 = LOW;
boolean aux_ic_11_node_15 = LOW;
boolean aux_ic_11_or_16 = LOW;
boolean aux_ic_11_or_17 = LOW;
boolean aux_ic_11_node_18 = LOW;
boolean aux_ic_11_node_19 = LOW;
boolean aux_ic_11_node_20 = LOW;
boolean aux_ic_11_node_21 = LOW;
boolean aux_ic_11_node_22 = LOW;
boolean aux_ic_11_node_23 = LOW;
boolean aux_ic_11_node_24 = LOW;
boolean aux_ic_11_or_25 = LOW;
boolean aux_ic_11_or_26 = LOW;
boolean aux_ic_11_or_27 = LOW;
boolean aux_ic_11_node_28 = LOW;
boolean aux_ic_11_node_29 = LOW;
boolean aux_ic_11_node_30 = LOW;
boolean aux_ic_11_node_31 = LOW;
boolean aux_ic_11_node_32 = LOW;
boolean aux_ic_11_node_33 = LOW;
boolean aux_ic_11_node_34 = LOW;
boolean aux_ic_11_node_35 = LOW;
boolean aux_ic_11_node_36 = LOW;
boolean aux_ic_11_node_37 = LOW;
boolean aux_ic_11_node_38 = LOW;
boolean aux_ic_11_or_39 = LOW;
boolean aux_ic_11_node_40 = LOW;
boolean aux_ic_11_node_41 = LOW;
boolean aux_ic_11_node_42 = LOW;
boolean aux_ic_11_node_43 = LOW;
boolean aux_ic_11_or_44 = LOW;
boolean aux_ic_11_and_45 = LOW;
boolean aux_ic_11_and_46 = LOW;
boolean aux_ic_11_and_47 = LOW;
boolean aux_ic_11_and_48 = LOW;
boolean aux_ic_11_and_49 = LOW;
boolean aux_ic_11_and_50 = LOW;
boolean aux_ic_11_node_51 = LOW;
boolean aux_ic_11_node_52 = LOW;
boolean aux_ic_11_and_53 = LOW;
boolean aux_ic_11_node_54 = LOW;
boolean aux_ic_11_node_55 = LOW;
boolean aux_ic_11_and_56 = LOW;
boolean aux_ic_11_node_57 = LOW;
boolean aux_ic_11_node_58 = LOW;
boolean aux_ic_11_node_59 = LOW;
boolean aux_ic_11_node_60 = LOW;
boolean aux_ic_11_node_61 = LOW;
boolean aux_ic_11_node_62 = LOW;
boolean aux_ic_11_node_63 = LOW;
boolean aux_ic_11_node_64 = LOW;
boolean aux_ic_11_node_65 = LOW;
boolean aux_ic_11_node_66 = LOW;
boolean aux_ic_11_node_67 = LOW;
boolean aux_ic_11_node_68 = LOW;
boolean aux_ic_11_node_69 = LOW;
boolean aux_ic_11_node_70 = LOW;
boolean aux_ic_11_node_71 = LOW;
boolean aux_ic_11_node_72 = LOW;
boolean aux_ic_11_not_73 = LOW;
boolean aux_ic_11_not_74 = LOW;
boolean aux_ic_11_not_75 = LOW;
boolean aux_ic_11_not_76 = LOW;
// End IC: DISPLAY-4BITS
// IC: DISPLAY-3BITS
boolean aux_ic_12_display7_g_middle = LOW;
boolean aux_ic_12_display7_f_upper_left_1 = LOW;
boolean aux_ic_12_display7_e_lower_left_2 = LOW;
boolean aux_ic_12_display7_d_bottom_3 = LOW;
boolean aux_ic_12_display7_a_top_4 = LOW;
boolean aux_ic_12_display7_b_upper_right_5 = LOW;
boolean aux_ic_12_display7_dp_dot_6 = LOW;
boolean aux_ic_12_display7_c_lower_right_7 = LOW;
boolean aux_ic_12_node_0 = LOW;
boolean aux_ic_12_or_1 = LOW;
boolean aux_ic_12_or_2 = LOW;
boolean aux_ic_12_and_3 = LOW;
boolean aux_ic_12_or_4 = LOW;
boolean aux_ic_12_not_5 = LOW;
boolean aux_ic_12_and_6 = LOW;
boolean aux_ic_12_and_7 = LOW;
boolean aux_ic_12_and_8 = LOW;
boolean aux_ic_12_xnor_9 = LOW;
boolean aux_ic_12_and_10 = LOW;
boolean aux_ic_12_or_11 = LOW;
boolean aux_ic_12_nand_12 = LOW;
boolean aux_ic_12_or_13 = LOW;
boolean aux_ic_12_or_14 = LOW;
boolean aux_ic_12_node_15 = LOW;
boolean aux_ic_12_node_16 = LOW;
boolean aux_ic_12_node_17 = LOW;
boolean aux_ic_12_node_18 = LOW;
boolean aux_ic_12_node_19 = LOW;
boolean aux_ic_12_node_20 = LOW;
boolean aux_ic_12_node_21 = LOW;
boolean aux_ic_12_node_22 = LOW;
boolean aux_ic_12_not_23 = LOW;
boolean aux_ic_12_and_24 = LOW;
boolean aux_ic_12_and_25 = LOW;
boolean aux_ic_12_and_26 = LOW;
boolean aux_ic_12_and_27 = LOW;
boolean aux_ic_12_node_28 = LOW;
boolean aux_ic_12_or_29 = LOW;
boolean aux_ic_12_node_30 = LOW;
boolean aux_ic_12_node_31 = LOW;
boolean aux_ic_12_xnor_32 = LOW;
boolean aux_ic_12_or_34 = LOW;
boolean aux_ic_12_and_35 = LOW;
boolean aux_ic_12_not_36 = LOW;
boolean aux_ic_12_or_37 = LOW;
// End IC: DISPLAY-3BITS
// IC: DISPLAY-4BITS
boolean aux_ic_13_display7_g_middle = LOW;
boolean aux_ic_13_display7_f_upper_left_1 = LOW;
boolean aux_ic_13_display7_e_lower_left_2 = LOW;
boolean aux_ic_13_display7_d_bottom_3 = LOW;
boolean aux_ic_13_display7_a_top_4 = LOW;
boolean aux_ic_13_display7_b_upper_right_5 = LOW;
boolean aux_ic_13_display7_dp_dot_6 = LOW;
boolean aux_ic_13_display7_c_lower_right_7 = LOW;
boolean aux_ic_13_node_0 = LOW;
boolean aux_ic_13_node_1 = LOW;
boolean aux_ic_13_node_2 = LOW;
boolean aux_ic_13_node_3 = LOW;
boolean aux_ic_13_and_4 = LOW;
boolean aux_ic_13_node_5 = LOW;
boolean aux_ic_13_node_6 = LOW;
boolean aux_ic_13_node_7 = LOW;
boolean aux_ic_13_node_8 = LOW;
boolean aux_ic_13_node_9 = LOW;
boolean aux_ic_13_node_10 = LOW;
boolean aux_ic_13_node_11 = LOW;
boolean aux_ic_13_node_12 = LOW;
boolean aux_ic_13_node_13 = LOW;
boolean aux_ic_13_node_14 = LOW;
boolean aux_ic_13_node_15 = LOW;
boolean aux_ic_13_or_16 = LOW;
boolean aux_ic_13_or_17 = LOW;
boolean aux_ic_13_node_18 = LOW;
boolean aux_ic_13_node_19 = LOW;
boolean aux_ic_13_node_20 = LOW;
boolean aux_ic_13_node_21 = LOW;
boolean aux_ic_13_node_22 = LOW;
boolean aux_ic_13_node_23 = LOW;
boolean aux_ic_13_node_24 = LOW;
boolean aux_ic_13_or_25 = LOW;
boolean aux_ic_13_or_26 = LOW;
boolean aux_ic_13_or_27 = LOW;
boolean aux_ic_13_node_28 = LOW;
boolean aux_ic_13_node_29 = LOW;
boolean aux_ic_13_node_30 = LOW;
boolean aux_ic_13_node_31 = LOW;
boolean aux_ic_13_node_32 = LOW;
boolean aux_ic_13_node_33 = LOW;
boolean aux_ic_13_node_34 = LOW;
boolean aux_ic_13_node_35 = LOW;
boolean aux_ic_13_node_36 = LOW;
boolean aux_ic_13_node_37 = LOW;
boolean aux_ic_13_node_38 = LOW;
boolean aux_ic_13_or_39 = LOW;
boolean aux_ic_13_node_40 = LOW;
boolean aux_ic_13_node_41 = LOW;
boolean aux_ic_13_node_42 = LOW;
boolean aux_ic_13_node_43 = LOW;
boolean aux_ic_13_or_44 = LOW;
boolean aux_ic_13_and_45 = LOW;
boolean aux_ic_13_and_46 = LOW;
boolean aux_ic_13_and_47 = LOW;
boolean aux_ic_13_and_48 = LOW;
boolean aux_ic_13_and_49 = LOW;
boolean aux_ic_13_and_50 = LOW;
boolean aux_ic_13_node_51 = LOW;
boolean aux_ic_13_node_52 = LOW;
boolean aux_ic_13_and_53 = LOW;
boolean aux_ic_13_node_54 = LOW;
boolean aux_ic_13_node_55 = LOW;
boolean aux_ic_13_and_56 = LOW;
boolean aux_ic_13_node_57 = LOW;
boolean aux_ic_13_node_58 = LOW;
boolean aux_ic_13_node_59 = LOW;
boolean aux_ic_13_node_60 = LOW;
boolean aux_ic_13_node_61 = LOW;
boolean aux_ic_13_node_62 = LOW;
boolean aux_ic_13_node_63 = LOW;
boolean aux_ic_13_node_64 = LOW;
boolean aux_ic_13_node_65 = LOW;
boolean aux_ic_13_node_66 = LOW;
boolean aux_ic_13_node_67 = LOW;
boolean aux_ic_13_node_68 = LOW;
boolean aux_ic_13_node_69 = LOW;
boolean aux_ic_13_node_70 = LOW;
boolean aux_ic_13_node_71 = LOW;
boolean aux_ic_13_node_72 = LOW;
boolean aux_ic_13_not_73 = LOW;
boolean aux_ic_13_not_74 = LOW;
boolean aux_ic_13_not_75 = LOW;
boolean aux_ic_13_not_76 = LOW;
// End IC: DISPLAY-4BITS
boolean aux_jk_flip_flop_14_0_q = LOW;
boolean aux_jk_flip_flop_14_0_q_inclk = LOW;
boolean aux_jk_flip_flop_14_1_q = HIGH;
boolean aux_jk_flip_flop_14_1_q_inclk = LOW;
...
void loop() {
    ...
    if (aux_jk_flip_flop_3_0_q && !aux_jk_flip_flop_6_0_q_inclk) { 
        if (HIGH && HIGH) { 
            boolean aux = aux_jk_flip_flop_6_0_q;
            aux_jk_flip_flop_6_0_q = aux_jk_flip_flop_6_1_q;
            aux_jk_flip_flop_6_1_q = aux;
        } else if (HIGH) {
            aux_jk_flip_flop_6_0_q = HIGH;
            aux_jk_flip_flop_6_1_q = LOW;
        } else if (HIGH) {
            aux_jk_flip_flop_6_0_q = LOW;
            aux_jk_flip_flop_6_1_q = HIGH;
        }
    }
    if (!HIGH) { 
        aux_jk_flip_flop_6_0_q = HIGH; //Preset
        aux_jk_flip_flop_6_1_q = LOW;
    } else if (!HIGH) { 
        aux_jk_flip_flop_6_0_q = LOW; //Clear
        aux_jk_flip_flop_6_1_q = HIGH;
    }
    ...
    aux_ic_11_node_68 = HIGH;
    aux_ic_11_node_72 = aux_ic_11_node_68;
    aux_ic_11_node_67 = LOW;
    aux_ic_11_node_65 = LOW;
    ...
    aux_ic_12_node_31 = LOW;
    aux_ic_12_node_30 = LOW;
    aux_ic_12_node_28 = LOW;
    aux_ic_12_or_1 = LOW || aux_ic_12_node_28;
    aux_ic_12_or_37 = LOW || aux_ic_12_node_30;
    aux_ic_12_or_2 = LOW || aux_ic_12_node_31;
    ...
    aux_ic_13_node_68 = HIGH;
    aux_ic_13_node_72 = aux_ic_13_node_68;
    aux_ic_13_node_67 = LOW;
    aux_ic_13_node_65 = LOW;
    ...
    if (aux_clock_7 && !aux_jk_flip_flop_14_0_q_inclk) { 
        if (HIGH && HIGH) { 
            boolean aux = aux_jk_flip_flop_14_0_q;
            aux_jk_flip_flop_14_0_q = aux_jk_flip_flop_14_1_q;
            aux_jk_flip_flop_14_1_q = aux;
        } else if (HIGH) {
            aux_jk_flip_flop_14_0_q = HIGH;
            aux_jk_flip_flop_14_1_q = LOW;
        } else if (HIGH) {
            aux_jk_flip_flop_14_0_q = LOW;
            aux_jk_flip_flop_14_1_q = HIGH;
        }
    }
    if (!HIGH) { 
        aux_jk_flip_flop_14_0_q = HIGH; //Preset
        aux_jk_flip_flop_14_1_q = LOW;
    } else if (!HIGH) { 
        aux_jk_flip_flop_14_0_q = LOW; //Clear
        aux_jk_flip_flop_14_1_q = HIGH;
    }
