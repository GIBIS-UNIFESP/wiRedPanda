...
namespace {
struct qt_meta_tag_ZN4LineE_t {};
} // unnamed namespace

template <> constexpr inline auto Line::qt_create_metaobjectdata<qt_meta_tag_ZN4LineE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Line, qt_meta_tag_ZN4LineE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Line::staticMetaObject = { {
    QMetaObject::SuperData::link<GraphicElement::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4LineE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4LineE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN4LineE_t>.metaTypes,
    nullptr
} };
...
void *Line::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4LineE_t>.strings))
