...
class MCPTestConfig(BaseModel):
    ...
    enable_validation: bool = Field(default=False, description="Enable schema validation during testing")
    verbose: bool = Field(default=True, description="Enable verbose output for debugging")
