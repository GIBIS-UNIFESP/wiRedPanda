...
class ProcessConfig(BaseModel):
    ...
    auto_cleanup: bool = Field(default=True, description="Automatically register cleanup handlers for signal handling")
    max_processes: Annotated[
        int, Field(ge=1, le=1000, description="Maximum number of processes to track simultaneously")
    ] = 100
