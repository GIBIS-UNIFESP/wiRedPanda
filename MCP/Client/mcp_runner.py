...
class MCPTestRunner:
    ...
    def __init__(
        ...
        self.organizer = MCPTestOrganizer(
            self.test_results, export_images=enable_image_export, keep_temp_files=keep_temp_files, verbose=verbose
        )
        ...
        self.export_circuit_image = lambda test_name: self.organizer.export_circuit_image(
            test_name, self.infrastructure
        )
