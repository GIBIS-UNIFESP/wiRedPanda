...
async def create_element_from_spec(mcp: MCPInfrastructure, spec: CircuitElementSpec) -> int | None:
    ...
    response = await mcp.send_command(
        "create_element", {"type": spec.element_type, "x": spec.position.x, "y": spec.position.y, "label": spec.label}
    )
...
async def create_simple_and_circuit(mcp: MCPInfrastructure) -> bool:
    ...
    # Create elements
    input_a_response = await mcp.send_command(
        "create_element", {"type": "InputButton", "x": 100.0, "y": 100.0, "label": "InputA"}
    )
    ...
    input_b_response = await mcp.send_command(
        "create_element", {"type": "InputButton", "x": 100.0, "y": 200.0, "label": "InputB"}
    )
    ...
    and_gate_response = await mcp.send_command(
        "create_element", {"type": "And", "x": 300.0, "y": 150.0, "label": "AndGate"}
    )
    ...
    led_response = await mcp.send_command("create_element", {"type": "Led", "x": 500.0, "y": 150.0, "label": "Output"})
    ...
    # Connect elements
    conn1_response = await mcp.send_command(
        "connect_elements", {"source_id": input_a, "source_port": 0, "target_id": and_gate, "target_port": 0}
    )
    ...
    conn2_response = await mcp.send_command(
        "connect_elements", {"source_id": input_b, "source_port": 0, "target_id": and_gate, "target_port": 1}
    )
    ...
    conn3_response = await mcp.send_command(
        "connect_elements", {"source_id": and_gate, "source_port": 0, "target_id": led_output, "target_port": 0}
    )
    ...
    for a_val, b_val in test_cases:
        # Set input values
        await mcp.send_command("set_input_value", {"element_id": input_a, "value": a_val})
        await mcp.send_command("set_input_value", {"element_id": input_b, "value": b_val})

        # Read output value
        output_response = await mcp.send_command("get_output_value", {"element_id": led_output})
...
async def create_simple_or_circuit(mcp: MCPInfrastructure) -> bool:
    ...
    or_gate_response = await mcp.send_command(
        "create_element", {"type": "Or", "x": 300.0, "y": 150.0, "label": "OrGate"}
    )
    ...
    # Connect elements
    conn1_response = await mcp.send_command(
        "connect_elements", {"source_id": input_a, "source_port": 0, "target_id": or_gate, "target_port": 0}
    )
    if not conn1_response or not conn1_response.success:
    ...
    conn2_response = await mcp.send_command(
        "connect_elements", {"source_id": input_b, "source_port": 0, "target_id": or_gate, "target_port": 1}
    )
    if not conn2_response or not conn2_response.success:
    ...
    conn3_response = await mcp.send_command(
        "connect_elements", {"source_id": or_gate, "source_port": 0, "target_id": led_output, "target_port": 0}
    )
    if not conn3_response or not conn3_response.success:
