...
QuickHistoryHandler::QuickHistoryHandler(QuickAppController *appController, const MCPValidator *validator)
    : QuickBaseHandler(appController, validator)
{
}

QJsonObject QuickHistoryHandler::handleCommand(const QString &command, const QJsonObject &params, const QJsonValue &requestId)
{
    if (command == "undo") {
...
QJsonObject QuickHistoryHandler::handleUndo(const QJsonObject &params, const QJsonValue &requestId)
{
    (void)params;
...
QJsonObject QuickHistoryHandler::handleRedo(const QJsonObject &params, const QJsonValue &requestId)
{
    (void)params;
    CanvasItem *canvas = currentCanvas();
    if (!canvas) {
...
QJsonObject QuickHistoryHandler::handleGetUndoStack(const QJsonObject &params, const QJsonValue &requestId)
{
    (void)params;
    CanvasItem *canvas = currentCanvas();
    if (!canvas) {
