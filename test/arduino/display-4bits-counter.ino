...
/* ========= Outputs ========== */
const int seven_segment_display23_g_middle = A1;
const int seven_segment_display23_f_upper_left = A2;
const int seven_segment_display23_e_lower_left = A3;
const int seven_segment_display23_d_bottom = A4;
const int seven_segment_display23_a_top = A5;
const int seven_segment_display23_b_upper_right = 2;
const int seven_segment_display23_dp_dot = 3;
const int seven_segment_display23_c_lower_right = 4;
...
void setup() {
    ...
    pinMode(seven_segment_display23_g_middle, OUTPUT);
    pinMode(seven_segment_display23_f_upper_left, OUTPUT);
    pinMode(seven_segment_display23_e_lower_left, OUTPUT);
    pinMode(seven_segment_display23_d_bottom, OUTPUT);
    pinMode(seven_segment_display23_a_top, OUTPUT);
    pinMode(seven_segment_display23_b_upper_right, OUTPUT);
    pinMode(seven_segment_display23_dp_dot, OUTPUT);
    pinMode(seven_segment_display23_c_lower_right, OUTPUT);
}
...
void loop() {
    ...
    aux_ic_input_jkflipflop_4 = aux_node_23;
    ...
    aux_ic_input_jkflipflop_4 = aux_node_21;
    ...
    // End IC: JKFLIPFLOP
    aux_node_5 = aux_jkflipflop_4_q_0;
    aux_node_6 = aux_jkflipflop_3_q_0_1;
    aux_and_7 = aux_node_24 && aux_node_25 && aux_node_5 && aux_node_6;
    aux_not_8 = !aux_and_7;
    ...
    aux_node_15 = aux_jkflipflop_13_q_0;
    aux_node_16 = aux_jkflipflop_12_q_0;
    aux_node_17 = aux_jkflipflop_4_q_0;
    aux_node_18 = aux_jkflipflop_3_q_0;
    // IC: DISPLAY-4BITS
    aux_ic_input_display_4bits_0 = aux_node_15;
    aux_ic_input_display_4bits_1 = aux_node_16;
    aux_ic_input_display_4bits_2 = aux_node_17;
    aux_ic_input_display_4bits_3 = aux_node_18;
    ...
    aux_node_21 = aux_node_11;
    aux_node_23 = aux_node_21;
    aux_node_24 = aux_jkflipflop_13_q_0;
    aux_node_25 = aux_jkflipflop_12_q_0_1;

    // Write output data
    digitalWrite(seven_segment_display23_g_middle, aux_display_4bits_19_display7_g_middle);
    digitalWrite(seven_segment_display23_f_upper_left, aux_display_4bits_19_display7_f_upper_left_1);
    digitalWrite(seven_segment_display23_e_lower_left, aux_display_4bits_19_display7_e_lower_left_2);
    digitalWrite(seven_segment_display23_d_bottom, aux_display_4bits_19_display7_d_bottom_3);
    digitalWrite(seven_segment_display23_a_top, aux_display_4bits_19_display7_a_top_4);
    digitalWrite(seven_segment_display23_b_upper_right, aux_display_4bits_19_display7_b_upper_right_5);
    digitalWrite(seven_segment_display23_dp_dot, aux_node_20);
    digitalWrite(seven_segment_display23_c_lower_right, aux_display_4bits_19_display7_c_lower_right_7);
}
