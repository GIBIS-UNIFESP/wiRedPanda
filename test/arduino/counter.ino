...
void loop() {
    ...
    //JK FlipFlop
    if (aux_clock_0 && !aux_jk_flip_flop_4_0_q_inclk) { 
        // Toggle mode (J=1, K=1)
        bool aux = aux_jk_flip_flop_4_0_q;
        aux_jk_flip_flop_4_0_q = aux_jk_flip_flop_4_1_q;
        aux_jk_flip_flop_4_1_q = aux;
    }
    aux_jk_flip_flop_4_0_q_inclk = aux_clock_0;
    //End of JK FlipFlop
    //JK FlipFlop
    if (aux_jk_flip_flop_4_0_q && !aux_jk_flip_flop_5_0_q_inclk) { 
        // Toggle mode (J=1, K=1)
        bool aux = aux_jk_flip_flop_5_0_q;
        aux_jk_flip_flop_5_0_q = aux_jk_flip_flop_5_1_q;
        aux_jk_flip_flop_5_1_q = aux;
    }
    aux_jk_flip_flop_5_0_q_inclk = aux_jk_flip_flop_4_0_q;
    //End of JK FlipFlop
    //JK FlipFlop
    if (aux_jk_flip_flop_5_0_q && !aux_jk_flip_flop_6_0_q_inclk) { 
        // Toggle mode (J=1, K=1)
        bool aux = aux_jk_flip_flop_6_0_q;
        aux_jk_flip_flop_6_0_q = aux_jk_flip_flop_6_1_q;
        aux_jk_flip_flop_6_1_q = aux;
    }
    aux_jk_flip_flop_6_0_q_inclk = aux_jk_flip_flop_5_0_q;
    //End of JK FlipFlop

    // Write output data
    digitalWrite(led2_0, aux_jk_flip_flop_6_1_q);
    digitalWrite(led3_0, aux_jk_flip_flop_5_1_q);
    digitalWrite(led4_0, aux_jk_flip_flop_4_1_q);
}
