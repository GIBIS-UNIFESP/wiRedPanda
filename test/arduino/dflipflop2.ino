...
void loop() {
    ...
    aux_nand_8 = !(aux_node_2 && aux_not_5);
    aux_node_9 = aux_input_switch_4;
    aux_nand_10 = !(aux_nand_14 && aux_nand_8);
    aux_nand_11 = !(aux_node_9 && aux_not_1);
    aux_node_12 = aux_node_7;
    aux_node_13 = aux_node_12;
    aux_nand_14 = !(aux_nand_11 && aux_nand_10);
    aux_node_15 = aux_clock_0;
    aux_node_16 = aux_node_15;
    aux_nand_17 = !(aux_nand_14 && aux_node_13);
    aux_nand_18 = !(aux_nand_17 && aux_nand_22);
    //D FlipFlop
    if (aux_node_16 && !aux_d_flip_flop_19_0_q_inclk) { 
    ...
    aux_d_flip_flop_19_0_q_inclk = aux_node_16;
    aux_d_flip_flop_19_0_q_last = aux_node_9;
    //End of D FlipFlop
    aux_nand_20 = !(aux_node_12 && aux_nand_10);
    aux_nand_22 = !(aux_nand_18 && aux_nand_20);

    // Write output data
    digitalWrite(led22_0, aux_d_flip_flop_19_0_q);
    digitalWrite(led24_0, aux_nand_18);
}
