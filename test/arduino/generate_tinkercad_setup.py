...
def main():
    ...
    for ino_file in examples_dir.glob('*.ino'):
        ...
        try:
            ...
            # Save JSON file
            json_file = examples_dir / f"{ino_file.stem}_tinkercad.json"
            ...
            # Save markdown guide
            md_file = examples_dir / f"{ino_file.stem}_setup.md"
    ...
    summary_file = examples_dir / "README.md"
    with open(summary_file, 'w') as f:
        f.write(summary)

    print(f"\n✓ Generated setup files for {len(all_circuits)} circuits in {examples_dir}")
