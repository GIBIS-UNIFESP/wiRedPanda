...
bool aux_ic_input_level2_priority_encoder_8to3_0 = LOW;
bool aux_ic_input_level2_priority_encoder_8to3_1 = LOW;
bool aux_ic_input_level2_priority_encoder_8to3_2 = LOW;
bool aux_ic_input_level2_priority_encoder_8to3_3 = LOW;
bool aux_ic_input_level2_priority_encoder_8to3_4 = LOW;
bool aux_ic_input_level2_priority_encoder_8to3_5 = LOW;
bool aux_ic_input_level2_priority_encoder_8to3_6 = LOW;
bool aux_ic_input_level2_priority_encoder_8to3_7 = LOW;
...
void computeLogic() {
    ...
    // IC: LEVEL2_PRIORITY_ENCODER_8TO3
    aux_ic_input_level2_priority_encoder_8to3_0 = input_switch1_val;
    aux_ic_input_level2_priority_encoder_8to3_1 = input_switch2_val;
    aux_ic_input_level2_priority_encoder_8to3_2 = input_switch3_val;
    aux_ic_input_level2_priority_encoder_8to3_3 = input_switch4_val;
    aux_ic_input_level2_priority_encoder_8to3_4 = input_switch5_val;
    aux_ic_input_level2_priority_encoder_8to3_5 = input_switch6_val;
    aux_ic_input_level2_priority_encoder_8to3_6 = input_switch7_val;
    aux_ic_input_level2_priority_encoder_8to3_7 = input_switch8_val;
    aux_level2_priority_encoder_8to3_0_node_2 = aux_ic_input_level2_priority_encoder_8to3_2;
    aux_level2_priority_encoder_8to3_0_node_3 = aux_ic_input_level2_priority_encoder_8to3_3;
    aux_level2_priority_encoder_8to3_0_node_4 = aux_ic_input_level2_priority_encoder_8to3_4;
    aux_level2_priority_encoder_8to3_0_node_5 = aux_ic_input_level2_priority_encoder_8to3_5;
    aux_level2_priority_encoder_8to3_0_node_6 = aux_ic_input_level2_priority_encoder_8to3_6;
    aux_level2_priority_encoder_8to3_0_node_7 = aux_ic_input_level2_priority_encoder_8to3_7;
    ...
    aux_level2_priority_encoder_8to3_0_node_1 = aux_ic_input_level2_priority_encoder_8to3_1;
    ...
    aux_level2_priority_encoder_8to3_0_node_0 = aux_ic_input_level2_priority_encoder_8to3_0;
...
void loop() {
    ...
    // Writing output data. //
    digitalWrite(led1_0, aux_level2_priority_encoder_8to3_0_addr0);
    digitalWrite(led2_0, aux_level2_priority_encoder_8to3_0_addr1_1);
    digitalWrite(led3_0, aux_level2_priority_encoder_8to3_0_addr2_2);
}
