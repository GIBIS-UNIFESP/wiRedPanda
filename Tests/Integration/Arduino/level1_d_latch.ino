...
bool aux_ic_input_level1_d_latch_0_0 = LOW;
bool aux_ic_input_level1_d_latch_0_1 = LOW;
...
void computeLogic() {
    ...
    // IC: LEVEL1_D_LATCH
    aux_ic_input_level1_d_latch_0_0 = input_switch1_val;
    aux_ic_input_level1_d_latch_0_1 = input_switch2_val;
    aux_level1_d_latch_0_node_0 = aux_ic_input_level1_d_latch_0_0;
    aux_level1_d_latch_0_node_1 = aux_ic_input_level1_d_latch_0_1;
...
void loop() {
    ...
    // Writing output data. //
    digitalWrite(led1_1, aux_level1_d_latch_0_q);
    digitalWrite(led2_1, aux_level1_d_latch_0_q_bar_1);
}
