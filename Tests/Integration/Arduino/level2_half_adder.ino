...
bool aux_ic_input_level2_half_adder_0 = LOW;
bool aux_ic_input_level2_half_adder_1 = LOW;
...
void computeLogic() {
    ...
    // IC: LEVEL2_HALF_ADDER
    aux_ic_input_level2_half_adder_0 = input_switch1_val;
    aux_ic_input_level2_half_adder_1 = input_switch2_val;
    aux_level2_half_adder_0_node_0 = aux_ic_input_level2_half_adder_0;
    aux_level2_half_adder_0_node_1 = aux_ic_input_level2_half_adder_1;
...
void loop() {
    ...
    // Writing output data. //
    digitalWrite(led1_0, aux_level2_half_adder_0_sum);
    digitalWrite(led2_0, aux_level2_half_adder_0_carry_1);
}
