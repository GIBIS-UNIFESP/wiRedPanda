...
bool aux_ic_input_level2_priority_mux_3to1_0 = LOW;
bool aux_ic_input_level2_priority_mux_3to1_1 = LOW;
bool aux_ic_input_level2_priority_mux_3to1_2 = LOW;
bool aux_ic_input_level2_priority_mux_3to1_3 = LOW;
bool aux_ic_input_level2_priority_mux_3to1_4 = LOW;
...
void computeLogic() {
    ...
    // IC: LEVEL2_PRIORITY_MUX_3TO1
    aux_ic_input_level2_priority_mux_3to1_0 = input_switch1_val;
    aux_ic_input_level2_priority_mux_3to1_1 = input_switch2_val;
    aux_ic_input_level2_priority_mux_3to1_2 = input_switch3_val;
    aux_ic_input_level2_priority_mux_3to1_3 = input_switch4_val;
    aux_ic_input_level2_priority_mux_3to1_4 = input_switch5_val;
    aux_level2_priority_mux_3to1_0_node_1 = aux_ic_input_level2_priority_mux_3to1_2;
    aux_level2_priority_mux_3to1_0_node_2 = aux_ic_input_level2_priority_mux_3to1_4;
    aux_level2_priority_mux_3to1_0_node_4 = aux_ic_input_level2_priority_mux_3to1_3;
    aux_level2_priority_mux_3to1_0_node_0 = aux_ic_input_level2_priority_mux_3to1_0;
    aux_level2_priority_mux_3to1_0_node_3 = aux_ic_input_level2_priority_mux_3to1_1;
    //Multiplexer
...
void loop() {
    ...
    // Writing output data. //
    digitalWrite(led1_0, aux_level2_priority_mux_3to1_0_out);
}
