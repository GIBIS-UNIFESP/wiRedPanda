...
void TestMUXDEMUXComprehensive::testMux4to1()
{
    ...
    std::vector<InputSwitch> dataIn(4);
...
void TestMUXDEMUXComprehensive::testMux8to1()
{
    ...
    std::vector<InputSwitch> dataIn(8);
    std::vector<InputSwitch> selectLines(3);
    Led out;
    Mux mux;
...
void TestMUXDEMUXComprehensive::testDemux1to4()
{
    ...
    InputSwitch in;
    std::vector<InputSwitch> selectLines(2);
    std::vector<Led> outs(4);
    Demux demux;
