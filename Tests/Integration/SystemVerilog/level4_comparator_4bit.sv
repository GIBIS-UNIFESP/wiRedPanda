...
// Module for LEVEL4_COMPARATOR_4BIT (generated from level4_comparator_4bit.panda)
module level4_comparator_4bit_ic (
    input a0,
    input a1,
    input a2,
    input a3,
...
/* ====== Aux. Variables ====== */
// IC instance: LEVEL4_COMPARATOR_4BIT (level4_comparator_4bit_ic)
wire w_level4_comparator_4bit_ic_inst_1_greater;
wire w_level4_comparator_4bit_ic_inst_1_equal;
wire w_level4_comparator_4bit_ic_inst_1_less;


// Assigning aux variables. //
level4_comparator_4bit_ic level4_comparator_4bit_ic_inst_1 (
    .a0(input_switch1),
    .a1(input_switch2),
    .a2(input_switch3),
    .a3(input_switch4),
    ...
    .b2(input_switch7),
    .b3(input_switch8),
    .greater(w_level4_comparator_4bit_ic_inst_1_greater),
    .equal(w_level4_comparator_4bit_ic_inst_1_equal),
    .less(w_level4_comparator_4bit_ic_inst_1_less)
);

// Writing output data. //
assign led10_1 = w_level4_comparator_4bit_ic_inst_1_greater;
assign led11_1 = w_level4_comparator_4bit_ic_inst_1_equal;
assign led12_1 = w_level4_comparator_4bit_ic_inst_1_less;
endmodule
