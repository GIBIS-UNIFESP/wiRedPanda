...
class ALUSelector5wayBuilder(ICBuilderBase):
    ...
    async def create(self) -> bool:
        ...
        for source_id, mux_id, port in [
            (result_inputs[0], l1_mux1, 0),  # result0 to l1_mux1 Data[0]
            (result_inputs[1], l1_mux1, 1),  # result1 to l1_mux1 Data[1]
            (result_inputs[2], l1_mux2, 0),  # result2 to l1_mux2 Data[0]
            (result_inputs[3], l1_mux2, 1),  # result3 to l1_mux2 Data[1]
        ]:
