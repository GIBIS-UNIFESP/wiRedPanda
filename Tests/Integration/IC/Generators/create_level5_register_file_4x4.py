...
class RegisterFile4x4Builder(ICBuilderBase):
    """Builder for Register File 4x4 IC"""

    async def create(self) -> bool:
        """Create Register File 4x4 IC"""
        num_registers = 4
        data_width = 4
        address_bits = 2

        await self.begin_build("Register File 4×4")
        ...
        # Save circuit as IC
        output_file = str(IC_COMPONENTS_DIR / "level5_register_file_4x4.panda")
...
async def build(mcp) -> bool:
    ...
    builder = RegisterFile4x4Builder(mcp, verbose=True)
