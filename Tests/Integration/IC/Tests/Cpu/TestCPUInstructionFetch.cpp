...
void TestCPUInstructionFetch::testInstructionFetchBasic()
{
    QFETCH(int, initialPC);
    QFETCH(int, cyclesPerFetch);
    // This is an integration test combining PC + Memory + IR
...
void TestCPUInstructionFetch::testInstructionFetchBasic_data()
{
...
void TestCPUInstructionFetch::testInstructionFetchEdgeCases()
{
    QFETCH(int, initialPC);
    QFETCH(int, cyclesPerFetch);
    // This is an integration test combining PC + Memory + IR
...
void TestCPUInstructionFetch::testInstructionFetchEdgeCases_data()
{
    QTest::addColumn<int>("initialPC");
    QTest::addColumn<int>("cyclesPerFetch");
...
void TestCPUInstructionFetch::testInstructionFetchSequences()
{
    QFETCH(int, initialPC);
    QFETCH(int, cyclesPerFetch);
    // This is an integration test combining PC + Memory + IR
...
void TestCPUInstructionFetch::testInstructionFetchSequences_data()
{
    QTest::addColumn<int>("initialPC");
    QTest::addColumn<int>("cyclesPerFetch");
