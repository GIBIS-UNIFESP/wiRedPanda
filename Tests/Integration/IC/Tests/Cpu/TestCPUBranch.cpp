...
void TestCPUBranch::testBranchSignFlag()
{
    QFETCH(int, opcode);
    QFETCH(bool, zeroFlag);
    QFETCH(bool, negativeFlag);
...
void TestCPUBranch::testBranchSignFlag_data()
{
    QTest::addColumn<int>("opcode");         // Instruction opcode
    QTest::addColumn<bool>("zeroFlag");      // Zero flag state
    QTest::addColumn<bool>("negativeFlag");  // Negative flag state
...
void TestCPUBranch::testBranchUnconditional()
{
    QFETCH(int, opcode);
    QFETCH(bool, zeroFlag);
    QFETCH(bool, negativeFlag);
...
void TestCPUBranch::testBranchUnconditional_data()
{
    QTest::addColumn<int>("opcode");         // Instruction opcode
    QTest::addColumn<bool>("zeroFlag");      // Zero flag state
    QTest::addColumn<bool>("negativeFlag");  // Negative flag state
...
void TestCPUBranch::testBranchZeroFlag()
{
    QFETCH(int, opcode);
    QFETCH(bool, zeroFlag);
    QFETCH(bool, negativeFlag);
...
void TestCPUBranch::testBranchZeroFlag_data()
{
    QTest::addColumn<int>("opcode");         // Instruction opcode
    QTest::addColumn<bool>("zeroFlag");      // Zero flag state
    QTest::addColumn<bool>("negativeFlag");  // Negative flag state
