...
void TestICInline::testEmbedSimulatesCorrectly()
{
    ...
    for (int i = 0; i < 4; ++i) {
        ...
        sim->update();
        QCOMPARE(TestUtils::inputStatus(&led), expectedAND[i]);
    }
}
...
void TestICInline::testICDropZoneMimeAcceptance()
{
    ...
    MAKE_DRAG_ENTER_EVENT(enterFileBased, QPoint(10, 10), Qt::CopyAction, fileBasedMime.get(), Qt::LeftButton, Qt::NoModifier);
    ...
    MAKE_DRAG_ENTER_EVENT(enterEmbedded, QPoint(10, 10), Qt::CopyAction, embeddedMime.get(), Qt::LeftButton, Qt::NoModifier);
    ...
    MAKE_DRAG_ENTER_EVENT(enterEmbOnFile, QPoint(10, 10), Qt::CopyAction, embeddedMime.get(), Qt::LeftButton, Qt::NoModifier);
    ...
    MAKE_DRAG_ENTER_EVENT(enterFileOnFile, QPoint(10, 10), Qt::CopyAction, fileBasedMime.get(), Qt::LeftButton, Qt::NoModifier);
...
void TestICInline::testICDropZoneWiredInUI()
{
    ...
    MAKE_DRAG_ENTER_EVENT(enterEvent, QPoint(10, 10), Qt::CopyAction, embeddedMime.get(), Qt::LeftButton, Qt::NoModifier);
    ...
    MAKE_DRAG_ENTER_EVENT(enterEvent2, QPoint(10, 10), Qt::CopyAction, fileMime.get(), Qt::LeftButton, Qt::NoModifier);
...
void TestICInline::testICDropZoneDropEventSignals()
{
    // Embedded zone: file-backed drop → embedByFileRequested
    {
        ...
        MAKE_DRAG_ENTER_EVENT(dragEnter, QPoint(10, 10), Qt::CopyAction, mime.get(), Qt::LeftButton, Qt::NoModifier);
...
void TestICInline::testTrashButtonDragAcceptance()
{
    ...
    MAKE_DRAG_ENTER_EVENT(enterCurrent, QPoint(10, 10), Qt::CopyAction, currentMime.get(), Qt::LeftButton, Qt::NoModifier);
    ...
    MAKE_DRAG_ENTER_EVENT(enterLegacy, QPoint(10, 10), Qt::CopyAction, legacyMime.get(), Qt::LeftButton, Qt::NoModifier);
    ...
    MAKE_DRAG_ENTER_EVENT(enterText, QPoint(10, 10), Qt::CopyAction, textMime.get(), Qt::LeftButton, Qt::NoModifier);
