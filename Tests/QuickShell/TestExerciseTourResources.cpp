...
void TestExerciseTourResources::testDiscoverMergesManagedContentDir()
{
    ...
    // are exercised above; this covers managedContentDir() -- the teacher/IT-admin-managed
    // classroom location -- actually merging a JSON entry dropped into it via discover().
