...
/// Label upright/position-on-rotation behavior has no Quick-side test technique yet: element
/// labels are rendered by App/Element/ElementLabel or drawn directly in CanvasItem's paint
/// pass, not as a child item that a test can walk and inspect.
