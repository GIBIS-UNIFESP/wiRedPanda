...
// -- same reasoning as TestCPUInstructionExecute/TestCPUInstructionFetch/
// TestCPUMemoryInterface/TestCPURegisterBank: runQuickTestSuite() already does the equivalent
// setup once, globally.
