...
struct ParityGeneratorFixture {
    ...
    bool build()
    {
        ...
        parityOutput = static_cast<Led *>(builder->addOwnedElement(new Led()));

        ic = static_cast<IC *>(builder->addOwnedElement(loadBuildingBlockIC("level2_parity_generator.panda")));
