...
struct ProgramCounter4bitFixture {
    ...
    bool build()
    {
        ...
        builder->addOwned(clock, load, inc, reset);
...
// Reset must force PC to 0. The register clears asynchronously (~Clear
// path), mirroring the 8-bit PC family.
