...
using QuickTestUtils::clockToggle;
 ...
 */
void buildSimple2StateFsm(QuickCircuitBuilder* builder,
                          ...
                          Simulation*& sim)
{
    ...
    builder->addOwned(triggerSwitch, clockSwitch, outStateFf, stateLed, stateNotLed);
