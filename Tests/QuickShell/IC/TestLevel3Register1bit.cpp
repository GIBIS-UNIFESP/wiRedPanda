...
struct Register1bitFixture {
    ...
    bool build()
    {
        ...
        builder->addOwned(data, clock, writeEnable, reset, q, notQ);
...
void TestLevel3Register1Bit::testRegisterAsyncReset()
{
    ...
    QCOMPARE(QuickTestUtils::inputStatus(f.q), false);
    QCOMPARE(QuickTestUtils::inputStatus(f.notQ), true);
}
...
void TestLevel3Register1Bit::testRegisterWriteOne()
{
    ...
    QCOMPARE(QuickTestUtils::inputStatus(f.q), 1);
    QCOMPARE(QuickTestUtils::inputStatus(f.notQ), 0);
}
...
void TestLevel3Register1Bit::testRegisterWriteZero()
{
    ...
    QCOMPARE(QuickTestUtils::inputStatus(f.q), 0);
    QCOMPARE(QuickTestUtils::inputStatus(f.notQ), 1);
}
