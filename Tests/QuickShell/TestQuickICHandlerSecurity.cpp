...
/// reaches for -- WorkSpace is a real QWidget (constructing one here would abort with
/// "QWidget: Cannot create a QWidget without QApplication", since this binary's runner
/// deliberately only ever constructs a QGuiApplication, matching wiredpanda's own
/// production Main.cpp).
