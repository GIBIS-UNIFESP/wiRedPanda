...
void TestLogicGates::testAndGateBehavior()
{
    ...
    QCOMPARE(QuickTestUtils::inputStatus(&led), false);  // 0 AND 0 = 0

    sw1.setOn(false); sw2.setOn(true); sim->update();
    QCOMPARE(QuickTestUtils::inputStatus(&led), false);  // 0 AND 1 = 0

    sw1.setOn(true); sw2.setOn(false); sim->update();
    QCOMPARE(QuickTestUtils::inputStatus(&led), false);  // 1 AND 0 = 0

    sw1.setOn(true); sw2.setOn(true); sim->update();
    QCOMPARE(QuickTestUtils::inputStatus(&led), true);   // 1 AND 1 = 1
}
...
void TestLogicGates::testOrGateBehavior()
{
    ...
    // Test OR truth table
    sw1.setOn(false); sw2.setOn(false); sim->update();
    QCOMPARE(QuickTestUtils::inputStatus(&led), false);  // 0 OR 0 = 0

    sw1.setOn(false); sw2.setOn(true); sim->update();
    QCOMPARE(QuickTestUtils::inputStatus(&led), true);   // 0 OR 1 = 1

    sw1.setOn(true); sw2.setOn(false); sim->update();
    QCOMPARE(QuickTestUtils::inputStatus(&led), true);   // 1 OR 0 = 1

    sw1.setOn(true); sw2.setOn(true); sim->update();
    QCOMPARE(QuickTestUtils::inputStatus(&led), true);   // 1 OR 1 = 1
}
...
void TestLogicGates::testNotGateBehavior()
{
    ...
    QCOMPARE(QuickTestUtils::inputStatus(&led), true);   // NOT 0 = 1

    sw.setOn(true); sim->update();
    QCOMPARE(QuickTestUtils::inputStatus(&led), false);  // NOT 1 = 0
}
...
void TestLogicGates::testNandGateBehavior()
{
    ...
    sw1.setOn(false); sw2.setOn(false); sim->update();
    QCOMPARE(QuickTestUtils::inputStatus(&led), true);   // 0 NAND 0 = 1

    sw1.setOn(false); sw2.setOn(true); sim->update();
    QCOMPARE(QuickTestUtils::inputStatus(&led), true);   // 0 NAND 1 = 1

    sw1.setOn(true); sw2.setOn(false); sim->update();
    QCOMPARE(QuickTestUtils::inputStatus(&led), true);   // 1 NAND 0 = 1

    sw1.setOn(true); sw2.setOn(true); sim->update();
    QCOMPARE(QuickTestUtils::inputStatus(&led), false);  // 1 NAND 1 = 0
}
...
void TestLogicGates::testNorGateBehavior()
{
    ...
    sw1.setOn(false); sw2.setOn(false); sim->update();
    QCOMPARE(QuickTestUtils::inputStatus(&led), true);   // 0 NOR 0 = 1

    sw1.setOn(false); sw2.setOn(true); sim->update();
    QCOMPARE(QuickTestUtils::inputStatus(&led), false);  // 0 NOR 1 = 0

    sw1.setOn(true); sw2.setOn(false); sim->update();
    QCOMPARE(QuickTestUtils::inputStatus(&led), false);  // 1 NOR 0 = 0

    sw1.setOn(true); sw2.setOn(true); sim->update();
    QCOMPARE(QuickTestUtils::inputStatus(&led), false);  // 1 NOR 1 = 0
}
...
void TestLogicGates::testXorGateBehavior()
{
    ...
    sw1.setOn(false); sw2.setOn(false); sim->update();
    QCOMPARE(QuickTestUtils::inputStatus(&led), false);  // 0 XOR 0 = 0

    sw1.setOn(false); sw2.setOn(true); sim->update();
    QCOMPARE(QuickTestUtils::inputStatus(&led), true);   // 0 XOR 1 = 1

    sw1.setOn(true); sw2.setOn(false); sim->update();
    QCOMPARE(QuickTestUtils::inputStatus(&led), true);   // 1 XOR 0 = 1

    sw1.setOn(true); sw2.setOn(true); sim->update();
    QCOMPARE(QuickTestUtils::inputStatus(&led), false);  // 1 XOR 1 = 0
}
...
void TestLogicGates::testXnorGateBehavior()
{
    ...
    sw1.setOn(false); sw2.setOn(false); sim->update();
    QCOMPARE(QuickTestUtils::inputStatus(&led), true);   // 0 XNOR 0 = 1

    sw1.setOn(false); sw2.setOn(true); sim->update();
    QCOMPARE(QuickTestUtils::inputStatus(&led), false);  // 0 XNOR 1 = 0

    sw1.setOn(true); sw2.setOn(false); sim->update();
    QCOMPARE(QuickTestUtils::inputStatus(&led), false);  // 1 XNOR 0 = 0

    sw1.setOn(true); sw2.setOn(true); sim->update();
    QCOMPARE(QuickTestUtils::inputStatus(&led), true);   // 1 XNOR 1 = 1
}
