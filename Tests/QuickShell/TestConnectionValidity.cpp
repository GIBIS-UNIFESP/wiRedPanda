...
void TestConnectionValidity::testPortValidityStyleAtCreation()
{
    ...
    // visible in freshly created and freshly loaded circuits.
...
void TestConnectionValidity::testIsConnectionAllowedRejectsRxPort()
{
    ...
    QVERIFY(!ConnectionManager::isConnectionAllowed(src->outputPort(0), node->inputPort(0)));
}
...
void TestConnectionValidity::testIsConnectionAllowedRejectsTxOutputPort()
{
    ...
    QVERIFY(!ConnectionManager::isConnectionAllowed(txNode->outputPort(0), dstElm->inputPort(0)));
}
...
void TestConnectionValidity::testIsConnectionAllowedPermitsNonePort()
{
    ...
    QVERIFY(ConnectionManager::isConnectionAllowed(src->outputPort(0), noneNode->inputPort(0)));
    QVERIFY(ConnectionManager::isConnectionAllowed(noneNode->outputPort(0), dst->inputPort(0)));
}
...
void TestConnectionValidity::testIsConnectionAllowedPermitsTxInputPort()
{
    ...
    QVERIFY(ConnectionManager::isConnectionAllowed(src->outputPort(0), txNode->inputPort(0)));
}
...
void TestConnectionValidity::testIsConnectionAllowedPermitsRxOutputPort()
{
    ...
    QVERIFY(ConnectionManager::isConnectionAllowed(rxNode->outputPort(0), dst->inputPort(0)));
}
...
void TestConnectionValidity::testConnectionRejectionReasonMessages()
{
    ...
    QVERIFY(!ConnectionManager::isConnectionAllowed(andElm->outputPort(0), andElm->inputPort(0)));
    QVERIFY(ConnectionManager::isConnectionAllowed(src->outputPort(0), andElm->inputPort(0)));
}
