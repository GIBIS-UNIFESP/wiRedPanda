...
// container node itself is excluded, since it does not simulate.
...
// elements are freed by resetInternalState() while Simulation::m_sortedElements
...
void TestDanglingPointer::hardening_icRegistryReloadHelpersMustUseSimulationBlocker()
{
    ...
    QVERIFY2(helperBody.contains("SimulationBlocker"),
             ...
             "Simulation::m_sortedElements stays stale until the caller's "
