...
flowRegistry['ui_menu_dispatch'] = {
  ...
  nodes: [
        ...
        ['d_trig',  'Has trigger?',                            'decision',''],
        ['trig',    'Add "Change trigger"',                    'step',    ''],
        ['d_appear','Can change\nappearance?',                 'decision',''],
        ['appear',  'Add "Change/Restore\nappearance"',        'step',    ''],
        ['rotate',  'Add "Rotate L/R"',                        'step',    'Always present'],
        ['d_freq',  'Has frequency?',                          'decision',''],
        ['freq',    'Add "Change frequency"',                  'step',    ''],
        ...
        ['match',   'Execute selected action',                 'end', ''],
      ],
  edges: [
        ['start',   'build'],
        ['build',   'd_label'],
