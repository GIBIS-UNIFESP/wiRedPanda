...
flowRegistry['sim_cycle'] = {
  ...
  nodes: [
        ...
        ['build_conn', 'buildConnectionGraph()', 'step', 'Walk each element input port \u2192 find source via QNEConnection \u2192 connectPredecessor()', 'sim_init'],
        ['wireless',   'connectWirelessElements()',                'step',     'Build Tx label\u2192element map, override Rx predecessors'],
        ['ic_init', 'IC::initializeSimulation()', 'step', 'Recursively build sub-circuit sim graphs for each IC element', 'sim_init'],
        ['sort', 'sortSimElements()', 'key', 'Build successor graph \u2192 topologicalSort(). Assigns priority per element. Detects feedback \u2192 m_simFeedbackNodes', 'sim_topo_sort'],
        ...
        ['d_fb',       'Has feedback\nloops?',                     'decision', ''],
        ['single', 'Single pass:\nupdateLogic()\nin topo order', 'step', 'Highest priority first', 'ge_logic'],
