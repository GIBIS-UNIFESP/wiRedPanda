...
| 2 | App/CodeGen/ | in progress | ArduinoCodeGen.cpp: **done** (100%, 44/44 functions, ~35 documented exclusions). Still to do: SystemVerilogCodeGen.cpp (76%, ~200 missing lines — the bigger of the two files here), CodeGenUtils.h (90%, 2 lines), SystemVerilogCodeGen.h (90%, 1 line), ArduinoCodeGen.h (already 100%). |
