 ...
 * \brief Production DialogProvider and FileDialogProvider for wiredpanda: instantiates
 ...
 * QFileDialog needs a real QApplication, which wiredpanda (QGuiApplication only) never
 * constructs. The \a parent QWidget* the interface takes is always ignored here (ported
