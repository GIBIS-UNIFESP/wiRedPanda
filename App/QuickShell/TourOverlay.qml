...
// see custom functions through -- confirmed the hard way: an earlier draft routing through
// root.Window.window tripped two real "member not found" qmllint warnings).
Item {
    id: root
