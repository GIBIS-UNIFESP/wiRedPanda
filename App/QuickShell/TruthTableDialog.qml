...
// The truth table editor dialog -- production's floating QDialog + QTableWidget
// (App/UI/ElementEditor.cpp's m_tableBox). A pure view over
                    ...
                    Repeater {
                        ...
                        delegate: Label {
                            ...
                            MouseArea {
                                ...
                                // Mirrors ElementEditor.cpp:80's QTableWidget::cellDoubleClicked
                                // connection -- Widgets requires a double-click, not a single
                                // click, to toggle an output bit.
                                onDoubleClicked: root.editor.toggleTruthTableCell(rowDelegate.index, cellDelegate.index)
                            }
                        }
                    }
                }
