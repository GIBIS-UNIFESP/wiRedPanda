...
void MainWindowUi::setupUi(QMainWindow *MainWindow)
{
    ...
    actionAlignTop->setObjectName("actionAlignTop");
    actionAlignBottom = new QAction(MainWindow);
    actionAlignBottom->setObjectName("actionAlignBottom");
    actionAlignHorizontalCenter = new QAction(MainWindow);
    actionAlignHorizontalCenter->setObjectName("actionAlignHorizontalCenter");
    actionAlignVerticalCenter = new QAction(MainWindow);
    actionAlignVerticalCenter->setObjectName("actionAlignVerticalCenter");
    actionDistributeHorizontally = new QAction(MainWindow);
    actionDistributeHorizontally->setObjectName("actionDistributeHorizontally");
    actionDistributeVertically = new QAction(MainWindow);
    actionDistributeVertically->setObjectName("actionDistributeVertically");
    ...
    actionICPreview = new QAction(MainWindow);
    actionICPreview->setObjectName("actionICPreview");
    actionICPreview->setCheckable(true);
...
"}\n");
    ...
    menuEdit->addSeparator();
    menuEdit->addAction(actionAlignLeft);
    menuEdit->addAction(actionAlignHorizontalCenter);
    menuEdit->addAction(actionAlignRight);
    menuEdit->addAction(actionAlignTop);
    menuEdit->addAction(actionAlignVerticalCenter);
    menuEdit->addAction(actionAlignBottom);
    menuEdit->addSeparator();
    menuEdit->addAction(actionDistributeHorizontally);
    menuEdit->addAction(actionDistributeVertically);
    menuEdit->addSeparator();
...
void MainWindowUi::retranslateUi()
{
    ...
    actionChangeTrigger->setShortcut(QStringLiteral("F3"));
    actionClearSelection->setText(QCoreApplication::translate("MainWindow", "Cl&ear selection"));
    actionClearSelection->setShortcut(QStringLiteral("Esc"));
    ...
    actionAlignLeft->setText(QCoreApplication::translate("MainWindow", "Align &Left"));
    actionAlignRight->setText(QCoreApplication::translate("MainWindow", "Align &Right"));
    actionAlignTop->setText(QCoreApplication::translate("MainWindow", "Align &Top"));
    actionAlignBottom->setText(QCoreApplication::translate("MainWindow", "Align &Bottom"));
    actionAlignHorizontalCenter->setText(QCoreApplication::translate("MainWindow", "Align Horizontal &Centers"));
    actionAlignVerticalCenter->setText(QCoreApplication::translate("MainWindow", "Align &Vertical Centers"));
    actionDistributeHorizontally->setText(QCoreApplication::translate("MainWindow", "Distribute &Horizontally"));
    actionDistributeVertically->setText(QCoreApplication::translate("MainWindow", "Distribute Verti&cally"));
    actionFullscreen->setText(QCoreApplication::translate("MainWindow", "F&ullscreen"));
    actionFullscreen->setShortcut(QStringLiteral("F11"));
    ...
    actionMute->setShortcut(QStringLiteral("Ctrl+M"));
