 ...
 */
struct CopyOperation {
    QString srcPath;   ///< Source IC file path to copy from.
    QString destPath;  ///< Destination IC file path to copy to.
    bool needed = false; ///< True if a copy is required for this operation.
};
...
struct SerializationContext {
    ...
    CopyOperation copyOperation = {};  ///< IC file copy state for paste/duplicate operations.
