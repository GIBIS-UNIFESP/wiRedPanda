...
namespace {
constexpr int    kDefaultColumnWidth = 49;    //!< Per-column pixel width at reset zoom.
constexpr int    kMaxSimLength       = 2048;  //!< Maximum allowed simulation length.
constexpr int    kMaxScenePixels     = 4000;  //!< Scene size limit before forced zoom reset.
constexpr double kZoomStep           = 1.25;  //!< Multiplicative factor per zoom step.
} // namespace
