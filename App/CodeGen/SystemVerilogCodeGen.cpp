    ...
    for (auto *elm : elements) {
        ...
        // Flip-flops and other stateful elements use auxiliary variables
            ...
            case ElementType::TruthTable: {
                ...
                // One always-block per output (F19): output k reads key bits
                // 256*k + row. Emitting per-output keeps the single-output
                // text byte-identical to the historical form.
