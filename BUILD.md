...
Here's how one could use aqtinstall to install Qt 6.9.3 on a Debian-based distro.
...
~/venv/bin/aqt install-qt linux desktop 6.9.3 --outputdir ~/Qt
PATH=~/Qt/6.9.3/gcc_64/bin:$PATH
export PATH
```
