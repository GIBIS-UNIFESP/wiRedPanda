export default {
  ...
  'home.title': 'ホーム',
  'home.intro':
    'wiRedPanda は、学生、教育者、愛好家がデジタル回路を学ぶために設計された強力で直感的なツールです。使いやすいインターフェースと高度な機能を備え、回路の理解と作成をインタラクティブで魅力的な体験に変えます。',
  ...
  'home.feature.interface.content':
    'コンポーネントをドラッグ＆ドロップし、ワイヤーを接続して、簡単かつ効率的に回路を構築できます。',
  'home.feature.analysis.title': '詳細な分析',
  'home.feature.analysis.content':
    'beWavedDolphin 波形シミュレーターを使用して回路を分析し、問題を特定・修正できます。',
  ...
  'about.history':
    'このプロジェクトは2015年に、Fábio Cappabianco 博士、Davi Morales、Lucas Lellis、Rodrigo Torres によって開始されました。論理回路の学習を簡単にし、100％無料でクロスプラットフォームなソフトウェアを開発することを目指しています。使いやすさの理念のもと、現在では UNIFESP のデジタル回路教育や、サンジョゼ・ドス・カンポスの公立学校の高校生向けデジタル論理教育プロジェクトで使用されています。',
  'about.campusAlt': 'Unifesp キャンパス',
  'about.contribute':
    '私たちは積極的に開発を進めています。バグの報告や新しいアイデアの共有をご希望でしたら、GitHub でディスカッションを開いてください！あなたのご協力がソフトウェアをより良くします。',
