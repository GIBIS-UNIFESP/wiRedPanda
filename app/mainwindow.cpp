    ...
    , m_ui(std::make_unique<MainWindow_Ui>())
{
    ...
    connect(m_ui->actionExportToVerilog,  &QAction::triggered,        this,                &MainWindow::on_actionExportToVerilog_triggered);
...
void MainWindow::on_actionExportToVerilog_triggered()
{
    if (!m_currentTab) {
        return;
    }
