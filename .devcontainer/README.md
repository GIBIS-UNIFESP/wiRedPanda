...
```bash
# Get AI assistance with development
claude-code "How do I implement a new logic gate?"
claude-code "Explain this C++ code: [paste code]"
claude-code "Help me debug this CMake error"
```
